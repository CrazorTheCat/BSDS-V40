...
class LogicConfData:
    ...
    def encode(self: Writer):
        ...
        self.writeVint(len(events) + 4) #4 it a ChampionShip(2 Stages) and Club League(Power Match and Default Game Mode)
